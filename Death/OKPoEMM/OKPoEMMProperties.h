...
extern NSString* const FontFile2;
...
//Death
//Death
extern NSString* const ScrollVerticalMargins;		//top margin between edge and text
extern NSString* const ScrollHorizontalMargins;	//left and right margins between e
extern NSString* const ScrollTextFiles;
extern NSString* const ScrollFonts;
extern NSString* const ScrollSpeeds;
extern NSString* const ScrollColors;
extern NSString* const ScrollFlickerSpeed;
extern NSString* const ScrollFlickerTime;
extern NSString* const ScrollFlickerActivityMultiplier;
extern NSString* const ScrollFlickerLayers;

extern NSString* const FunnelTextFile;
extern NSString* const FunnelTextFiles;
extern NSString* const FunnelFont;
extern NSString* const FunnelFontSize;
extern NSString* const FunnelFontScaling;
extern NSString* const FunnelColorRange;
extern NSString* const FunnelSpeed;

extern NSString* const LightningCellHeight;
extern NSString* const LightningCellMargin;
extern NSString* const LightningRowsSpeed;
extern NSString* const LightningColumns;
extern NSString* const LightningHorizontalNoise;
extern NSString* const LightningVerticalNoise;
extern NSString* const LightningHorizontalSpeed;
extern NSString* const LightningVerticalSpeed;
extern NSString* const LightningTouchEffect;
extern NSString* const LightningMass;
extern NSString* const LightningMassSpeed;
extern NSString* const LightningColor;

extern NSString* const SkyColor;
extern NSString* const GroundColor;
extern NSString* const HorizonMargin;
extern NSString* const HorizonSpeed;

extern NSString* const TouchActivityIncrement;
extern NSString* const TouchActivityDecrement;
extern NSString* const TouchActivityHoldTime;
