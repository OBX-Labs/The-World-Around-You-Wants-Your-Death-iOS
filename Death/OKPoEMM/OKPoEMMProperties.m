...
NSString* const FontFile2 = @"FontFile2";
...
//Death
NSString* const ScrollVerticalMargins = @"ScrollVerticalMargins";		//top margin between edge and text
NSString* const ScrollHorizontalMargins = @"ScrollHorizontalMargins";	//left and right margins between e
NSString* const ScrollTextFiles=@"ScrollTextFiles"; 
NSString* const ScrollFonts=@"ScrollFonts";  
NSString* const ScrollSpeeds=@"ScrollSpeeds";
NSString* const ScrollColors= @"ScrollColors";
NSString* const ScrollFlickerSpeed = @"ScrollFlickerSpeed";
NSString* const ScrollFlickerTime = @"ScrollFlickerTime";
NSString* const ScrollFlickerActivityMultiplier = @"ScrollFlickerActivityMultiplier";
NSString* const ScrollFlickerLayers = @"ScrollFlickerLayers";

NSString* const FunnelTextFile= @"FunnelTextFile";
NSString* const FunnelTextFiles= @"FunnelTextFiles";
NSString* const FunnelFont = @"FunnelFont";
NSString* const FunnelFontSize = @"FunnelFontSize";
NSString* const FunnelFontScaling = @"FunnelFontScaling";
NSString* const FunnelColorRange = @"FunnelColorRange";
NSString* const FunnelSpeed = @"FunnelSpeed";

NSString* const LightningCellHeight =@"LightningCellHeight";
NSString* const LightningCellMargin = @"LightningCellMargin";
NSString* const LightningRowsSpeed = @"LightningRowsSpeed";
NSString* const LightningColumns = @"LightningColumns";
NSString* const LightningHorizontalNoise = @"LightningHorizontalNoise";
NSString* const LightningVerticalNoise = @"LightningVerticalNoise";
NSString* const LightningHorizontalSpeed = @"LightningHorizontalSpeed";
NSString* const LightningVerticalSpeed = @"LightningVerticalSpeed";
NSString* const LightningTouchEffect = @"LightningTouchEffect";
NSString* const LightningMass = @"LightningMass";
NSString* const LightningMassSpeed = @"LightningMassSpeed";
NSString* const LightningColor = @"LightningColor";

NSString* const SkyColor = @"SkyColor";
NSString* const GroundColor = @"GroundColor";
NSString* const HorizonMargin = @"HorizonMargin";
NSString* const HorizonSpeed = @"HorizonSpeed";

NSString* const TouchActivityIncrement = @"TouchActivityIncrement";
NSString* const TouchActivityDecrement = @"TouchActivityDecrement";
NSString* const TouchActivityHoldTime = @"TouchActivityHoldTime";
